...
void fun2()
{
	...
	for (int j = 0;; j++) {
		...
		/* -- Read */
		Console::puts("FUN 2: Reading Block "); Console::puti(read_block); Console::puts(" from disk...\n");
		...
		Console::puts("FUN 2: Writing buffer to Block "); Console::puti(write_block); Console::puts(" on disk...\n");
